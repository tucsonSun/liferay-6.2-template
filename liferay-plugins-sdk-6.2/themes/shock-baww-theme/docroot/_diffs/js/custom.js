jQuery(document).ready(function() {
	 ...
	 * 2) If topParent exists and not equal to 'Admin Home' disable href
	 */

	//Find the breadcrumb top parent element
	//If it exists and not equal to 'Admin Home' disable
	...
	if (liElement.length) {
		...
		if(value !="Admin Home") {
			...
			$(aElement).attr('style','cursor:default; color: $yellow;');
		}
	}
